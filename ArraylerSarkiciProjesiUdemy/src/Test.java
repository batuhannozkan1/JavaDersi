...
public class Test {
    ...
    public static void sarkiciGuncelle(){
        ...
        System.out.print("Guncellemek istediginiz pozisyon(1,2,3,4,5...) : ");
        int pozisyon = scanner.nextInt();
        scanner.nextLine();
        
        String yeniIsim = scanner.nextLine();
        
        sarkicilar.sarkiciGuncelle(yeniIsim, pozisyon);
    ...
    public static void sil(){
        ...
        System.out.println("Silmek istediginiz pozisyon(1,2,3,4,5...)");
        int pozisyon = scanner.nextInt();
